...
2. 不过，依旧推荐安装较新版本的 python -> [CentOS安装Python3.10教程](https://blog.musnow.top/posts/847195816/?utm_source=khl-py-docs)
3. 运行以下命令来安装 [khl.py](https://github.com/TWT233/khl.py)：
...
如果你安装的是 python3.10.x，则应该运行如下命令安装
